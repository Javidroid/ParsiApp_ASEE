...
public class ListAdapterPostSaved extends RecyclerView.Adapter<ListAdapterPostSaved.ViewHolder> {
    ...
    final ListAdapterPostSaved.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(Post item);
    }

    public ListAdapterPostSaved(List<Post> postList, Context context, ListAdapterPostSaved.OnItemClickListener listener){
    ...
    @Override
    public ListAdapterPostSaved.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View view = mInlfater.inflate(R.layout.list_saved_tweet, null);
        return new ListAdapterPostSaved.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ListAdapterPostSaved.ViewHolder holder, final int position) {
