...
public class CU14_ConsultarCarpeta_Test {
    ...
    @Test
    public void cU14_ConsultarCarpeta_Test() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("ConsultarCarpeta"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.email_register),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("cu14@gmail.com"), closeSoftKeyboard());
        ...
        onView(withId(R.id.listRecyclerView))
                .perform(actionOnItemAtPosition(0, CU14_ConsultarCarpeta_Test.MyViewAction.clickChildViewWithId(R.id.save)));
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.nameFolderView), withText("Mundial"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Mundial")));
        ...
        onView(withId(R.id.listRecyclerView))
                .perform(actionOnItemAtPosition(0, CU14_ConsultarCarpeta_Test.MyViewAction.clickChildViewWithId(R.id.cdF)));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.folderName),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Cosas"), closeSoftKeyboard());
