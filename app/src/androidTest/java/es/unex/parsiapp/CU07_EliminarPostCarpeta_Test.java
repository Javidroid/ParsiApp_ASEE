...
public class CU07_EliminarPostCarpeta_Test {
    ...
    @Test
    public void cU07_EliminarPostCarpeta_Test() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("EliminarPostCarpeta"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.email_register),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("cu07@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.folderName),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("Mundial"), closeSoftKeyboard());
        ...
        onView(withId(R.id.listRecyclerView))
                .perform(actionOnItemAtPosition(0, CU07_EliminarPostCarpeta_Test.MyViewAction.clickChildViewWithId(R.id.save)));
        ...
        onView(withId(R.id.listRecyclerView))
                .perform(actionOnItemAtPosition(1, CU07_EliminarPostCarpeta_Test.MyViewAction.clickChildViewWithId(R.id.save)));
        ...
        onView(withId(R.id.listRecyclerView))
                .perform(actionOnItemAtPosition(0, CU07_EliminarPostCarpeta_Test.MyViewAction.clickChildViewWithId(R.id.cdF)));
        ...
        ViewInteraction textView = onView(
                allOf(IsInstanceOf.<View>instanceOf(android.widget.TextView.class), withText("Borrar post de carpeta"),
                        withParent(allOf(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class)))),
                        isDisplayed()));
        textView.check(matches(withText("Borrar post de carpeta")));
